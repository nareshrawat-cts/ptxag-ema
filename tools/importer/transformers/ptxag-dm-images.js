...
/**
 * Transformer: ptxag (www.ptxag.com) Dynamic Media / Scene7 image handling.
 * Source contains Scene7 IS/Image URLs (s7d9.scene7.com/is/image/agco/...).
 * Converts DM <img> tags into anchors that round-trip through markdown; the
 * companion auto-block in scripts/scripts.js rebuilds responsive <picture>
 * elements at render time. Runs afterTransform only (parsers extract <img>
 * into block cells between the hooks). Helpers copied byte-identically from
 * references/dm-scene7-helpers.js (subset used by the transformer).
 */
